...
console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'yyyy-MM-dd'))
...
const handleTaskFromAddButtonEvent = (e) => {
    ...
    const newTask = new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](title, date, description, priority)
...
const todolist = (() => {
    ...
    const displayTasks = () => {
        Object.keys(localStorage).forEach(key => {
            ...
            ;(0,_DisplayController__WEBPACK_IMPORTED_MODULE_1__.addDetailsEventListenr)(item)
        })
    }
...
/* harmony import */ var _js_Date_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/Date.js */ "./src/js/Date.js");
